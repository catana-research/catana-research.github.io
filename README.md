...
- Add a post to _posts/POST_NAME
- Add images to assets/images/POST_NAME
...
- Add the following include in files containing altair plots:
- Save the altair plot as HTML in the directory: `_includes\altair`
- Strip all data from the HTML file except the `<body>` tags and replace `viz` with a unique identifier for the page.
